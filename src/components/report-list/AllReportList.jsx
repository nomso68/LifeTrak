...
//           const userName = item.userName || "Unknown"; // Assuming each item has a `userName` field
//           if (!acc[userName]) {
//             acc[userName] = [];
//           }
//           acc[userName].push({
...
//     // Prepare rows with user names and their data
//     const rows = [];
//     Object.keys(reportData).forEach((userName) => {
//       rows.push([userName]); // Add the user's name
//       reportData[userName].forEach((item) => {
//         rows.push([
//           "", // Empty cell for the user name, since it's already in the previous row
//           item.date,
//           item.vitals.bloodTemp,
//           item.vitals.pulseRate,
//           item.vitals.respRate,
