        ...
        <div className="other-details">
          ...
          <div>
            <input
              ...
              value={form.gender}
            />
            <button className="edit-other" onClick={() => toggleEdit("gender")}>
              <Pencil1 main={false} />
            </button>
          </div>
        </div>
        <div className="other-details">
          ...
          <div>
            <input
              ...
              value={form.weight}
            />
            <button className="edit-other" onClick={() => toggleEdit("weight")}>
              <Pencil1 main={false} />
            </button>
          </div>
        </div>
        <div className="other-details">
          ...
          <div>
            <input
              ...
              value={form.height}
            />
            <button className="edit-other" onClick={() => toggleEdit("height")}>
              <Pencil1 main={false} />
            </button>
          </div>
        </div>
